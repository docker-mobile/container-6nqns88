...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6nqns88.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6nqns88.containers.anotherwebservice.com/
...
```
git clone git@github.com:docker-mobile/container-6nqns88.git
cd container-6nqns88
```
...
```
docker attach container-6nqns88
```
